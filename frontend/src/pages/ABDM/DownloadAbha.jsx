...
const DownloadAbha = ({ onBack }) => (
  <div style={containerStyle}>
    <button onClick={onBack} style={backBtn}>← Back</button>
    <div style={cardStyle}>
      <div style={headerStyle}><CreditCard color={theme.colors.primary} /> <h2>ABHA Card</h2></div>
      <p>Generate a digital PDF version of the ABHA Health Card.</p>
      <button style={primaryBtn}>Download PDF</button>
    </div>
  </div>
);
